                ...
                <tr>
                   ...
                   <td>
                    ...
                    <td class="text-end d-flex justify-content-end gap-2">
                        ...
                        {{-- $url = route('quotation.public', $quotation->quotation_number);
                        ...
                        {{-- PDF --}}
                        {{-- <a href="{{ $expired ? $disabledUrl : route('quotations.template', $quotation->id) }}"
                        target="{{ $expired ? '_self' : '_blank' }}"
                        class="btn btn-sm btn-accent {{ $expired ? 'text-muted' : '' }}"
                        @if($expired) onclick="{{ $expiredMessage }}" @endif>
